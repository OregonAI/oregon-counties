...
id: curry-code-article-3-division-2
title: 'Article 3 - Division 2'
doc_type: ordinance
citation: 'Article 3 - Division 2'
authority_level: county_ordinance
issuing_body: 'Curry County Board of Commissioners'
source_url: https://www.currycountyor.gov/Article%203%20-%20Division%202.pdf?t=202407101004170
source_format: pdf
retrieved: '2026-08-01'
source_sha256: 9c4ac2df7286434f0ffbd3b09911e3066e13be581f34f967a1ce1d1e5bacbcdf
...
maintainer: 'OregonAI'
text_source: ocr
conversion_notes: 'OCR-derived. Engines: ocrmypdf/tesseract 5.3.4 and PaddleOCR PP-OCRv6, run independently on the same scan. Word agreement 0.997; figure agreement 0.969; dictionary ratio 0.984. Artifacts disclosed, not repaired. NOT human-verified.'
relationships:
  implements: []
  implemented_by: []
  references_external:
...
# Article 3 - Division 2 (Article 3 - Division 2)

## At a glance

OCR-derived text of Article 3 - Division 2. Not human-verified.
...
name utilizing the same process as noted herein.
      ...
      SECTION 3.02.060_           NOTIFICATION OF PROPERTY OWNERS AND AGENCIES
...
DIVISION TWO                                                                                         Page 1
owners of record. Such notice shall include a statement as to where and when any objections
should be filed pursuant to Section 3.02.070 below.

    SECTION 3.02.070_        APPEAL OF THE COMMUNITY DEVELOPMENT DIRECTOR
                                         DECISION
...
Community Development Director to the Board of Commissioners.
                        ...
                        SECTION 3.02.080        _FILING OF NEW ROAD NAME
...
the same.
                             ...
                             SECTION 3.02.090_        ROADS COVERED
...
(1)     Addresses will be assigned only to improved lots or parcels which include a driveway
leading onto the named road.
(2)     Subsequent addressing of lots will be accomplished pursuant to Section 3.02.140 below.
...
vehicle drivers to immediately ascertain the address of each residence.
      ...
      SECTION 3.02.140_     PARTITIONS AND SUBDIVISIONS - ROAD NAMING AND
                                       POSTING
...
rule in `AGENTS.md`: `ocrmypdf/tesseract` and `PaddleOCR PP-OCRv6` read it independently and agreed on 99.7% of
the word sequence, and on 96.9% of the figures. Dictionary-recognizable words: 98.4%.
